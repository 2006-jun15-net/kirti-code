...
namespace ChinookApp.DataAccess.Model
{
    public partial class ChinookContext : DbContext
    {
        ...
        public virtual DbSet<Pdepartment> Pdepartment { get; set; }
        public virtual DbSet<PempDetails> PempDetails { get; set; }
        public virtual DbSet<Pemployee> Pemployee { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Pdepartment>(entity =>
            {
                entity.ToTable("PDepartment");
            ...
            modelBuilder.Entity<PempDetails>(entity =>
            {
                entity.ToTable("PEmpDetails");
                ...
                entity.HasOne(d => d.Employee)
                    .WithMany(p => p.PempDetails)
                    .HasForeignKey(d => d.EmployeeId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PEmpDetai__Count__02FC7413");
            });

            modelBuilder.Entity<Pemployee>(entity =>
            {
                entity.ToTable("PEmployee");
                ...
                entity.HasOne(d => d.Dept)
                    .WithMany(p => p.Pemployee)
                    .HasForeignKey(d => d.DeptId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__PEmployee__DeptI__05D8E0BE");
            });
