...
namespace ProductCatalog.App
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            if(true) 
            {
                // the BuiltinProductSorter value is being implicitly casted to ISortingAlgorithm<List<product>> type.
                sorterToUse = sorter2;

                // this is allowed by the compiler specifically bacuse that class does indeed implement that interface.
                // this is also called "upcasting"

                // downcasting example:
                //ProductSorter sorter3 = (ProductSorter)sorterToUse;
                // this might fail: what if it's really a BuiltinProductSorter value?
